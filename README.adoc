...
:loki-distributed-chart-version: 0.80.6
:promtail-chart-version: 6.17.1

A https://devops-stack.io[DevOps Stack] module to deploy and configure Loki

=== Usage Alloy

All kubernetes events are by default pushed to Loki under the following label `{job="loki.source.kubernetes_events"} `
